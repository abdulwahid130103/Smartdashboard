...
Route::middleware($middleware_auth)->group(function () {
    ...
    Route::group(['prefix' => 'data'], function () {
        Route::name('data.')->group(function () {
            ...
            Route::post('/import_rekap_ketetapan_perolehan_bphtb', 'Data\ImportController@import_rekap_ketetapan_perolehan_bphtb')->name('import_rekap_ketetapan_perolehan_bphtb');
